...
<!--  
  ...
  <def-label name="VOLERLEX" closed="true">
    <tags-item lemma="voler" tags="vblex.*"/>
  </def-label>  
-->
...
-->
   <def-mult name="PREPPRNPOS" closed="true">
    <sequence>
      <label-item label="PREP"/>
...
<!--	<enforce-after label="DETM">
	...
	<enforce-after label="VHABERPARTPI">
		<label-set>
			<label-item label="VLEXPARTPI"/>
			<label-item label="VSERPARTPI"/>
			<label-item label="VHABERPARTPI"/>
	...
	<enforce-after label="VHABERPFCI">
		<label-set>
			<label-item label="VLEXPARTPI"/>
			<label-item label="VSERPARTPI"/>
			<label-item label="VHABERPARTPI"/>
	...
	<enforce-after label="VHABERSUBJ">
		<label-set>
			<label-item label="VLEXPARTPI"/>
			<label-item label="VSERPARTPI"/>
			<label-item label="VHABERPARTPI"/>

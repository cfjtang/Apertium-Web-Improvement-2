...
%%<CIA-20> apertium: unhammer * r15394 /trunk/apertium-nn-nb/freerbmt09_nnnb/ (freerbmt09_nnnb.tex notes.org freerbmt09_nnnb.org): rename so I don't inadvertently overwrite anything
...
The quantitative evaluation involved the post-edition of 000 machine translated
sentences from the Swedish Wikipedia. The sentences were selected from an 
article on history, run through the machine translation system and then a human
post-editor corrected the resulting Danish translation.

%% See http://wiki.apertium.org/wiki/Category:Swedish_and_Danish/Evaluation
\begin{table}
\centering
\begin{tabular}{|l|c|c|c|}
\hline
...
system. To compare the results of the three systems, we selected 100 sentences and translated

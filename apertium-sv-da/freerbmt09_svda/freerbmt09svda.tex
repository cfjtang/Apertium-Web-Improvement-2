...
Because of time constraints, and because GramTrans and Apertium translations were very similar, 
we considered the post-edited Apertium text to be valid also as post-edited GramTrans text.
This gives a small bias in disfavour of GramTrans which must be taken into account when making 
conclusions.

The results of this evaluation are shown in table~\ref{table:compeval} and show that, in spite 
of the small disfavour to Gramtrans, it scores better than Apertium and Google 
Translate scores does much worse than Apertium. 
...
artefacts such as \emph{överfart} translated as `passage'. 

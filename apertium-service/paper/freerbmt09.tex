...
Another approach used to implement a service based on Apertium by \cite{sanchez-cartagena2009scalable} makes use of a pool of {\tt\small apertium} processes: each translation request is routed to a process making use of the required language pair, and then its output is returned back to the service client.
...
% \item {\tt\small moses-service}, a service relying on {\tt\small moses}.
\end{itemize}

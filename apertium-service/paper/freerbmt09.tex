...
a toolkit for building and applying statistical language models; the language models were then compiled in binary format using IRSTLM~\citep{irstlm} and 
trained to minimize the error rate on a set of sentences from the same corpus. 

Both {\tt apertium-service} and {\tt moses-service}, was accepting translation requests in XML-RPC format and the free text used for timing was also 

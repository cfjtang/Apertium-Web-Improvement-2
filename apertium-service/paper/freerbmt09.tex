...
Scalability for {\tt apertium} and {\tt apertium-service} have been evaluated by calculating the average time required by the two systems to answer to $1024$ translations requests sequentially sent by a variable number of clients. Figure \ref{fig:compmt} shows the results of this comparison.

...
for its translation capabilities, and on N-Gram Based Text Categorization~\citep{textcat} for language detection. Our decision to use a
Rule-Based Machine Translation system was motivated by the following reasons:

\begin{itemize}
 %% in SMT la ``fluency'' può andare a discapito della ``fidelity''
 ...
 %% conoscenza linguistica codificata esplicitamente

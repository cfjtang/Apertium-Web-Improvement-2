...
{\bf Example:} MetaMap~\citep{metamap} is an application that allows mapping text to UMLS\textregistered 
Metathesaurus\textregistered\footnote{The UMLS\textregistered Metathesaurus\textregistered~\citep{umls}, the largest thesaurus in the biomedical domain, 
...
relationships among the concepts.} concepts, which have proved to be useful for many applications, including decision support 
...
\begin{itemize}
 \item \emph{Decoding} the meaning of the source text;
 \item \emph{Re-Encoding} this meaning in the destination language.
\end{itemize}
...
In addition, many greetings go to Jimmy O'Regan, Francis Tyers and others involved in The Apertium Project, for their constant help.

...
\begin{description}
 \item[Efficiency] -- Threads usually require less resources when compared to processes, and Inter-Process Communication (IPC) between multiple processes tend to be more complex than IPC between multiple threads belonging to the same process~\citep{tanenbaum};

...
elevated computational cost; in addition, resources as dictionaries are often mapped, during their acquisition, to hash tables, to reduce the
computational complexity of lookup operations, which also are computationally expensive, in time, to create (because of the repeated use of

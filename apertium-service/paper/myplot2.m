...
a = [254 255 258 254 258 256 258 258 261 260 261 288 264 275 272 272 273 305 297 297];
...
plot(x, log2(as), "-*;apertium-service;", 
	x, log2(a), "-+;apertium;",
	x, log2(aws), "-^;apertium-ws;",
	x, log2(ms), "-o;moses-service;",
	x, log2(m), "-x;moses;");

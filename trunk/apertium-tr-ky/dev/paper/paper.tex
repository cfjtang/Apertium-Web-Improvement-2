...
\begin{table}[htbp]
	...
	\subtable{
		\begin{tabular}{lll}
			...
			\midrule
			/алма-DA/ & [алмада] & \eng{apple-LOC} \\
			/каз-DA/ & [казда] & \eng{goose-LOC} \\
			/баш-DA/ & [башта] & \eng{head-LOC} \\
			\bottomrule
		\end{tabular}
	}
	\hspace{2em}

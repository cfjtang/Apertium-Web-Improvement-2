...
function show_form($textbox, $dir) {
	...
	print "<option value='ca-ro-lr' " . ($dir == 'ca-ro' ? ' selected=true' : '') . ">" . _("Catalan") . " &rarr; " . _("Romanian") . "</option>";
	...
	print "<option value='ca-ro-rl' " . ($dir == 'ro-ca' ? ' selected=true' : '') . ">" . _("Romanian") . " &rarr; " . _("Catalan") . "</option>";		

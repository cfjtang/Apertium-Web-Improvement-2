<?php
	...
	$text = array("ce este Apertium?", "cine elaborează Apertium?", "descărcări", "testați", "documentație", "interactionați!", "ultimele noutăți", "programe complementare", "finanțare", "utilizatori", "contact");

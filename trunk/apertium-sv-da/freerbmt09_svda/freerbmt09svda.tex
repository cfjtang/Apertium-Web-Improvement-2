...
This gives a small bias in favor of Apertium which must be taken into account when making conclusions.
...
of the natural bias favoring the Apertium translation, Gramtrans scores better and Google 
...
Gramtrans:
"Der findes en kort overfart ved det baltiske hav ved Helsingborg, på hvilket sted Själland kan ses fra Skåne, et sædvanligt tilhold for vikinger."

Google:
"Der er en kort passage i Østersøen i Helsingborg, i hvilken plads Zealand kan ses fra Scania, en regelmæssig tilholdssted for vikingerne."

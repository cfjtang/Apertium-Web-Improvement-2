...
public class Compression {
  ...
  int multibyte_read2(InputStreamReader input) throws IOException {
    char up;
    int result = 0;
  ...
  int multibyte_read(InputStreamReader input) throws IOException {
    char up;
    int result = 0;
  ...
  String String_read(InputStreamReader input) throws IOException {
    String retval = "";

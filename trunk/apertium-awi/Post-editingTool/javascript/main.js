	...
	if(event.target.tagName.toLowerCase() == 'input' && event.target.type.toLowerCase() == 'submit')
	{
		switch(event.target.name)
		{
			...
			case 'submit_input' :
				...
				var query_string = 'action_request=translate&' + buildRequestString(document.mainform, new Array('inputTMX', 'language_pair', 'text_input', 'pretrans_src[]', 'pretrans_dst[]', 'useapertiumorg') );
				var resultManager = function(str)
				{
					text_out_js_on.innerHTML = str+'<br />';

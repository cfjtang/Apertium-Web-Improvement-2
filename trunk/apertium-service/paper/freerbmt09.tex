...
\begin{description}
 ...
 \item[Stability] -- Because repetitious acquisition and release of resource can increase the risk of system instability (for example, repetitious acquisition and release of resources can lead to memory fragmentation problems typical of heap-based allocation~\citep{robust, realtime}); %% SHOULD YOU PUT A REF HERE ? -FMT

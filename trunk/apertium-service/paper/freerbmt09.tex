...
\begin{description}
 ...
 \item[Reuse] - since resources can be used also in different translation tasks (for example, tasks using different dictionaries can make use
  of the same transfer rules and lexical selectors), thus improving service's scalability;
\end{description}

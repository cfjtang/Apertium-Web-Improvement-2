...
\begin{description}
 ...
 \item[Predictability] -- because direct acquisition of a resource from an external resource environment (for example, a filesystem or a DBMS) can be characterised by nondeterministic timing~\citep{realtime};

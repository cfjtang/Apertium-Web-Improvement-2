...
they no longer need: the released resources are put back into the pool and can be acquired by other resource clients need them.
...
managed in a pool of resources, which allows pool clients to acquire them, and release them back to the pool when they're no longer needed.}
\label{fig:rp}
\end{figure}

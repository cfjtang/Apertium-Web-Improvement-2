g++ -L/usr/local/lib -o ApertiumServer src/*.cpp src/core/*.cpp src/format/*.cpp -I/usr/include/libxml++-2.6/ \
...
-lgobject-2.0 -lboost_thread-mt -lsigc-2.0 -lglib-2.0 -lxml++-2.6 -liqxmlrpc-server

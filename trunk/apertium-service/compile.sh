g++ -L/usr/local/lib -o Debug/apertium-service src/*.cpp src/core/*.cpp src/utils/*.cpp src/cg/*.cpp -I/usr/include/libxml++-2.6/ \
...
-ltextcat -liconv -licui18n -licudata -licuuc -lm -licuio -Isrc/cg/

...
make PAR_DONT_REMOVE_CONFLICTS=yes PAR_MAX=5 PAR_L1=$SL PAR_L2=$TL PAR_NO_SHORT_RESTRICTIONS=yes PAR_MY_EXTRACTING=yes $MARKERFLAG PAR_DATADIR="$DATADIR" PAR_RULELEARNINGLIBDIR="$FULLRULELEARNINGDIR" PAR_GIZADIR="$GIZADIR"
popd
